...
const TEXT = {
  ...
  showPassword: { my: "ပြရန်", en: "Show" },
  hidePassword: { my: "ဖျောက်ရန်", en: "Hide" },
  temporaryPassword: { my: "ယာယီစကားဝှက်", en: "Temporary Password" },
  currentPassword: { my: "လက်ရှိစကားဝှက်", en: "Current Password" },
  newPassword: { my: "စကားဝှက်အသစ်", en: "New Password" },
  confirmNewPassword: { my: "စကားဝှက်အသစ် အတည်ပြုရန်", en: "Confirm New Password" },
  passwordReset: { my: "စကားဝှက်ပြန်သတ်မှတ်ရန်", en: "Reset Password" },
  passwordResetHint: { my: "ယာယီစကားဝှက်အသစ်တစ်ခုထည့်ပါ သို့မဟုတ် Generate လုပ်ပြီး သိမ်းပါ။", en: "Enter a temporary password or generate one, then save it." },
  generatePassword: { my: "Generate လုပ်ရန်", en: "Generate" },
  savePassword: { my: "စကားဝှက်သိမ်းရန်", en: "Save Password" },
  changePassword: { my: "စကားဝှက်ပြောင်းရန်", en: "Change Password" },
  passwordUpdated: { my: "စကားဝှက်ပြင်ပြီးပါပြီ", en: "Password updated" },
  passwordMismatch: { my: "စကားဝှက်အသစ် ၂ ခုပြန်စစ်ပါ", en: "The new passwords do not match." },
  ...
  failedToUpdatePassword: { my: "စကားဝှက်ပြင်ဆင်၍ မရပါ", en: "Failed to update password." },
